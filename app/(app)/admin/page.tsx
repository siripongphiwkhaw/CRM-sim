  ...
  return (
    <div>
      <div className="mb-1 flex items-center justify-between text-sm">
        ...
        <span className="text-stone-500">{count}/{total} · {pct}%</span>
      </div>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card>
          <h2 className="mb-4 text-lg font-medium text-stone-900">Users & roles</h2>
          <table className="min-w-full divide-y divide-stone-200 text-sm">
            ...
            <tbody className="divide-y divide-stone-100">
              {users.map((u) => (
                <tr key={u.id}>
                  <td className="py-2 text-stone-800">{u.name}</td>
                  <td className="py-2 text-stone-500">{u.email}</td>
                  <td className="py-2">
